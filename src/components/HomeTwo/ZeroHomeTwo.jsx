            ...
            <div className="content-column col-xl-6 col-lg-12">
              <div className="inner-column">
                <span className="sub-title wow fadeInUp" data-wow-delay="300ms">
                  A leading solar service provider
                </span>
            ...
            <div className="image-column d-md-block d-none col-lg-6 col-md-12 col-sm-12">
              <div className="inner-column">
                <figure className="image">
                  <img src="../../assets/images/banner/3.png" alt="Image" />
                </figure>
                <figure className="image-2 bounce-y">
                  <img src="../../assets/images/banner/man-1.jpg" alt="Image" />
                </figure>
              </div>
            </div>
          </div>
